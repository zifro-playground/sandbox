...
{
	public class AgentInstance : MonoBehaviour,
		IPMCompilerStarted,
		IPMCompilerStopped
	{
		...
		public FractionVector3 GetDirectionFraction(Direction direction, float scale)
		{
			...
			case Direction.North:
				return new FractionVector3(0, 0, scale);
			case Direction.East:
				return new FractionVector3(scale, 0, 0);
			case Direction.South:
				return new FractionVector3(0, 0, -scale);
			case Direction.West:
				return new FractionVector3(-scale, 0, 0);
			case Direction.Forward:
				return (FractionVector3)(transform.forward * scale);
			case Direction.Backward:
				return -(FractionVector3)(transform.forward * scale);
			case Direction.Left:
				return -(FractionVector3)(transform.right * scale);
			case Direction.Right:
				return (FractionVector3)(transform.right * scale);
			case Direction.Up:
				return new FractionVector3(0, scale, 0);
			case Direction.Down:
				return new FractionVector3(0, -scale, 0);
			default:
